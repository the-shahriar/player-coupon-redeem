...
export class Initial1697350085134 implements MigrationInterface {
    name = 'Initial1697350085134'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`reward\` (\`id\` int NOT NULL AUTO_INCREMENT, \`status\` tinyint NOT NULL DEFAULT 1, \`perDayLimit\` int NOT NULL, \`totalLimit\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`player_coupon\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`playerId\` int NULL, \`couponId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
